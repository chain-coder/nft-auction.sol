...
// Anchor provides a macro for defining custom program-specific errors.
// Every msg (error message) is assigned a unique code.

#[error_code]
pub enum AuctionError {
    // 0x0 ~ 0x13 - Codes 0 ~ 19
    // These error codes are in line with the Solana Program Library.
    // Please refer this: https://github.com/solana-labs/solana-program-library/blob/master/token/program/src/error.rs

    // 0x64 ~ 0x1388 - Codes 100 ~ 5000
    // These codes are following the Anchor framework's standards.
