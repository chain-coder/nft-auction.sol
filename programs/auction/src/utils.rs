...
// A GLOBAL_AUTHORITY_SEED constant to seed creation of the Global Authority account
pub const GLOBAL_AUTHORITY_SEED: &str = "global-authority";

// Constants to manage auction duration and bid window
pub const DAY: u64 = 200; // temporary value, should be 86400 seconds for final version
pub const MIN_DURATION_AFTER_BID_SECS: u64 = 600; // 10 min

// Constants related to fees and minimum increments
...
// Producing HTO's specific constants
